...
const RhfShort = "react: A command to generate a helper function with test."

const RhfLong = `Can use the gen command to generate starter / boilerplate code for a helper function.
